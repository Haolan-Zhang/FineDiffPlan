...
from .timestep_sampler import get_schedule_jump
...
class GaussianDiffusion:
    ...
    def p_sample(
        ...
        if pred_xstart is not None:
            ...
            gt_keep_mask = 1 - F.interpolate(model_kwargs['mask'], size=(32, 32), mode='nearest')
            gt = model_kwargs['gt']
            gt = vae.encode(gt).latent_dist.sample().mul_(0.18215)
    ...
    def p_sample_loop_progressive(
        ...
        if True:
            ...
            jump_length = 10
            jump_n_sample = 10
            times = get_schedule_jump(t_T, n_sample, jump_length, jump_n_sample)
            ...
            for t_last, t_cur in time_pairs:
                ...
                if t_cur < t_last:  # reverse
                    ...
                    # print("something wrong", t_last, t_cur)
                    t_shift = 20
